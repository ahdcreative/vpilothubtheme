        ...
        <div class="col-lg-4">
            ...
            <ul class="nav nav-pills nav-justified mb-2" id="pills-tab" role="tablist">
                <li class="nav-item mx-1" role="presentation">
                    <a href="#pills-map" class="nav-link active pt-1 pb-1" id="pills-map-tab" role="tab" aria-controls="pills-map" aria-selected="true">
                        @lang('disposable.map')
                    </a>
                </li>
                @if($DBasic)
                ...
                @endif
                <li class="nav-item mx-1" role="presentation">
                    <a href="#pills-weather" class="nav-link pt-1 pb-1" id="pills-weather-tab" role="tab" aria-controls="pills-weather" aria-selected="false">
                        @lang('disposable.weather')
                    </a>
                </li>
                @if(count($airport->files) > 0 && Auth::check())
                    <li class="nav-item mx-1" role="presentation">
                        <a href="#pills-files" class="nav-link pt-1 pb-1" id="pills-files-tab" data-toggle="pill" role="tab" aria-controls="pills-files" aria-selected="false">
                ...
                <div class="tab-pane fade show active" id="pills-map" role="tabpanel" aria-labelledby="pills-map-tab">
                    <div class="card mb-2">
                        ...
                        <div class="card-footer p-0 px-1 small text-end">
                            <strong>{{ $airport->location.' / '.strtoupper($airport->country) }}</strong>
                        </div>
                    </div>
                </div>
