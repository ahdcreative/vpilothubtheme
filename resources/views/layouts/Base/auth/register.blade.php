            ...
            <div class="card mb-2">
                ...
                <div class="card-body p-1">
                    <div class="input-group input-group-sm mb-1">
                        ...
                        <input type="text" class="form-control" name="name" aria-label="name" aria-describedby="name">
                    </div>
                    <div class="input-group input-group-sm mb-1">
                    ...
                    @if(setting('pilots.allow_transfer:hours') === true)
                        <div class="input-group input-group-sm mb-1">
                            <span class="input-group-text col-lg-3"
                                  id="transfer_time">@lang('auth.transferhours')</span>
                    ...
                    <div class="input-group input-group-sm mb-1">
                        <span class="input-group-text col-lg-3"
                              id="password_confirmation">@lang('passwords.confirm')</span>
