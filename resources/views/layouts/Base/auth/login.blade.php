...
<div class="row mt-2">
    <div class="col-lg-4 mx-auto content-center">
        ...
        <div class="card">
            @if(Theme::getSetting('login_logo'))
            <img class="card-img-top" src="{{ public_asset('/img/theme_logo_big.png') }}">
            @endif
            <div class="card-body p-1">
                @if($errors->any())
                {!! implode('', $errors->all('
                <div class="alert alert-danger mb-1 p-1 px-2 fw-bold">:message</div>
                ')) !!}
                @endif
                ...
                <div class="input-group input-group-sm mb-2">
                    ...
                    <input
                            class="form-control" type="password" name="password" aria-label="password"
